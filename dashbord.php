                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <div class="text-muted">
                                                            <p class="mb-2">Welcome to Food Ordering System</p>
                                                            <h5 class="mb-1"><?php echo $_SESSION["adminusername"]; ?></h5>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="text-primary p-3">
                                                    <h5 class="text-primary">Welcome Back ! <?php echo $_SESSION["adminusername"]; ?></h5>
                                                    <p>Have a nice day</p>

                                                    <ul class="ps-3 mb-0">
                                                        <li class="py-1">7 + Orders</li>
...
<!-- Mirrored from themesbrand.com/skote/layouts/dashboard-saas.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jul 2022 08:31:58 GMT -->
</html>
